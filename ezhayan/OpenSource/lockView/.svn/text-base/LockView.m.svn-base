...
#import "LockView.h"
#define SteveZLineColor [UIUtils colorWithHexString:@"#40b49c"]
...
- (NSArray*)buttons
{
    if (_buttons == nil) {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            // 设置按钮的背景图片
            [button setBackgroundImage:[UIImage imageNamed:@"zc1.02_o1"] forState:UIControlStateNormal];
            [button setBackgroundImage:[UIImage imageNamed:@"zc1.02_o2"] forState:UIControlStateSelected];
            [button setBackgroundImage:[UIImage imageNamed:@"zc1.02_o3"] forState:UIControlStateDisabled];
