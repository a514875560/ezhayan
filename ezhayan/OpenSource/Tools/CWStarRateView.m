...
#define FOREGROUND_STAR_IMAGE_NAME @"info011_5_content_icon02_h"
#define BACKGROUND_STAR_IMAGE_NAME @"info011_5_content_icon02_n"
...
- (void)buildDataAndUI {
    ...
    _label = [[UILabel alloc] initWithFrame:CGRectMake(self.backgroundStarView.bounds.origin.x+self.backgroundStarView.bounds.size.width+10, self.backgroundStarView.bounds.origin.y, 60, self.backgroundStarView.bounds.size.height)];
...
- (void)layoutSubviews {
    ...
    _label.text = [NSString stringWithFormat:@"%.1f", self.scorePercent*5];
