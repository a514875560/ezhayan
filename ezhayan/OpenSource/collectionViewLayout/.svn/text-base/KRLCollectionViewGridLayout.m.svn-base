...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    UICollectionViewLayoutAttributes *HeadAttributes = [self layoutAttributesForSupplementaryViewOfKind:@"todoListHeadView" atIndexPath:[NSIndexPath indexPathForItem:0 inSection:0]];
    [visibleAttributes addObject:HeadAttributes];
...
- (nullable UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)elementKind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    attributes.frame = CGRectMake(0, 0, kDeviceWidth, self.headViewHeight);
    return attributes;
}
